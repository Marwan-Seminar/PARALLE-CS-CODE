...
namespace  SeminarParallelComputing.exercises.async.u_5_1_syntax_behaviour.soluition
{
    public class AsyncAwaitBehaviourSolution
    {

       public static void TestMain()
        {
            AsyncAwaitBehaviourSolution instance = new AsyncAwaitBehaviourSolution();
