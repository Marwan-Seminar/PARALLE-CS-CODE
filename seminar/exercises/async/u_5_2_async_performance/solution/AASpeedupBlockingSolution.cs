...
namespace SeminarParallelComputing.exercises.async.u_5_2_async_performance.solution
{
    /*
    ...
    */
    public class AsyncAwaitSpeedupBlockingSolution
    {
    ...
    class BlockingAsynchronousNaive
    {
        ...
        public static void RunTest()
        {
            Console.WriteLine("BlockingAsynchronousNaive: Calling Asynch Method");
        ...
        /*
         * An asynchroius job based on Task.Run()
         */
        async Task LongrunningJobAsync()
        {
            ...
            // await Task.Delay(3000); // this is the correct appraoch. Delay() is an awaitabale Method
    ...
    class BlockingAsynchronousFast
    {
        ...
        public static void RunTest()
        {
            Console.WriteLine("BlockingAsynchronousFast: Calling Asynch Method");

            new BlockingAsynchronousFast().CallBlockingJobsAsync();

            Console.WriteLine("BlockingAsynchronousFast: Asynch Call returned unawaited");

            // Hack to keep program alive (korrect would be, to use await and declare this method async)
            Thread.Sleep(10000);
        }
        /*
         * Calls several blocking tasks in sequential manner
        ...
        /*
         * A asynchronous job based on Thread.Sleep() or Task.Delay();
         */
        async Task LongrunningJobAsync()
        {
            ...
            // await Task.Delay(3000); // this is the correct approach
            // This is only for demonstation purposes, as it is not according to the guidelines: blocking Thread within a Task.Run() is not efficient.
            await System.Threading.Tasks.Task.Run(() => Thread.Sleep(3000));
            Console.WriteLine("Async Job woke up in Thread " + Thread.CurrentThread.ManagedThreadId);
