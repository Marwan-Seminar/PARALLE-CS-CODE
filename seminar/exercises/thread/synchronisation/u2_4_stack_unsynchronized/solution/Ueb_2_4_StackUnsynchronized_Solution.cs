...
namespace SeminarParallelComputing.seminar.exercises.thread.synchronization.u2_4_stack_unsynchronized.solution
{
    /*
    ...
    public class Ueb_2_4_StackUnsynchronized_Solution
    {
        ...
        {
            Ueb_2_4_StackUnsynchronized_Solution testInstance = new Ueb_2_4_StackUnsynchronized_Solution();
